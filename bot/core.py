"""BZBot-Kern: __init__, Start/Stop, 60-Hz-Game-Loop und Server-Updates (W5, FABLE-PLAN Teil 3)."""
...
from bzflag.obstacle_grid import ObstacleGrid
from bzflag.protocol import (
    DEFAULT_PORT, PLAYER_TYPE_TANK, TEAM_AUTOMATIC, MsgAlive,
    MsgKilled, MsgAddPlayer, MsgRemovePlayer, MsgPlayerUpdate,
    MsgPlayerUpdateSmall, MsgShotBegin, MsgShotEnd, MsgSetVar,
    MsgPlayerInfo, MsgTeamUpdate, MsgFlagUpdate, MsgTimeUpdate,
