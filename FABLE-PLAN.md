...
### N1a — 30-Hz-Update-Kadenz reparieren (Kadenz-Bug) ⭐
...
### N1b — UDP-Zieladresse einmal auflösen (DNS pro Paket) ⭐
...
2b. **Track N — Idle-Baseline (aus der Server-Messung, Teil 1b):** N1a (30-Hz-Kadenz-Fix) → N1b (UDP-Adress-Cache) → Nachmessung (User; Ziel <10% Idle) → danach ggf. N2 (Leerlauf-Early-Outs), N3 (Schublade).
